[Skip to main content](https://code.claude.com/docs/en/#content-area)
...
On this page
  * [Get started](https://code.claude.com/docs/en/#get-started)
  * [What you can do](https://code.claude.com/docs/en/#what-you-can-do)
  * [Use Claude Code everywhere](https://code.claude.com/docs/en/#use-claude-code-everywhere)
  * [Next steps](https://code.claude.com/docs/en/#next-steps)
...
## 
[​](https://code.claude.com/docs/en/#get-started)
Get started
...
## 
[​](https://code.claude.com/docs/en/#what-you-can-do)
What you can do
...
## 
[​](https://code.claude.com/docs/en/#use-claude-code-everywhere)
...
## 
[​](https://code.claude.com/docs/en/#next-steps)
Next steps
...
Terms and policies
[Privacy choices](https://code.claude.com/docs/en/)[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](https://www.anthropic.com/legal/consumer-terms)
Assistant
